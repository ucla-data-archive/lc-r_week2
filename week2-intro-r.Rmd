...
* A document type in R that lets you intersperse text, R code, images.
* Then you can `knit` above & this document will be rendered  into a webpage, a pdf, a word document
